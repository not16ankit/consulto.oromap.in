...
$key=  "vlSECtkZkfLjQdgw";
$hash=$_POST['hash'];
$paytmParams["MID"] = $mid;
$paytmParams["ORDER_ID"] = $orderid;
$paytmParams["CUST_ID"]=$_POST['customerid'];
$paytmParams["CHANNEL_ID"]=$_POST['channelid'];
...
{
$con->query("DELETE FROM verifytable WHERE username='".$email."'");
$con->query("INSERT INTO verifytable(username,code) VALUES('".$email."','".$hash."')");
}
}
echo $paytmChecksum;
?>